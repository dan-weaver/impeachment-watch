var BASE_URL =
  "https://api.propublica.org/congress/v1/115/house/committees.json";
var nextPage = 0;
var prevPage = 0;
var query;
var state = [];
...
function getJ(searchobject, callback) {
  $.getJSON(BASE_URL, searchobject, callback);
}
...
$(function() {
  ...
  var url =
    "https://api.propublica.org/congress/v1/115/house/committees/HSJU.json";
